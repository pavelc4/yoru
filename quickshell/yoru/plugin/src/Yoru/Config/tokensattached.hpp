...
class Tokens : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
    ...
    Q_PROPERTY(const yoru::config::AppearanceRounding* rounding READ rounding NOTIFY sourceChanged)
    Q_PROPERTY(const yoru::config::AppearanceSpacing* spacing READ spacing NOTIFY sourceChanged)
    Q_PROPERTY(const yoru::config::AppearancePadding* padding READ padding NOTIFY sourceChanged)
    Q_PROPERTY(const yoru::config::AppearanceFont* font READ font NOTIFY sourceChanged)
    Q_PROPERTY(const yoru::config::AppearanceTransparency* transparency READ transparency NOTIFY sourceChanged)
    Q_PROPERTY(const yoru::config::SizeTokens* sizes READ sizes NOTIFY sourceChanged)
    Q_PROPERTY(const yoru::config::AnimTokens* anim READ anim NOTIFY sourceChanged)
